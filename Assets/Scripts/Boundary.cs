...
public static class Boundary
{
    ...
    public const float xMin = -2f, xMax = 2f, yMin = -1.16f, yMax = 1.4f, zMin = -5f, zMax = 5f;
    public const int pageNum = 20, pageBase = 10;   // 실제 페이지 수는 pageNum + 1입니다.
    public const float sight = 1.8f;                  // 투사체나 상대 캐릭터가 플레이어에게 보이는 z좌표 최대 거리입니다.
